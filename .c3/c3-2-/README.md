---
id: c3-2
c3-seal: c2a3f9531e4f370ff88d6e18afc0ae08f10e7e07ac11bfbb7bb1d2b2abf51e8f
title: lifecycle
type: container
parent: c3-0
goal: |-
...
| --- | --- | --- | --- | --- |
| c3-201 | manifest |  | active | Compute and diff the one integrity ledger — path, role, sha256 per MANAGED/TEMPLATE file plus |
| c3-210 | init |  | active | Stamp a brand-new wiki instance from scratch — scaffold, seed, hooks wired, first commit made — |
| c3-211 | upgrade |  | active | Bring an existing wiki instance forward to a newer (or, with --allow-downgrade, older) harness |
