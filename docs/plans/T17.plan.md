...
### Task 1: T17 — Downgrade guard

Requirement contract: `/Users/hip/repo/wiki-harness-analysis/plan/briefs/T17.md` — read it in full, including any trailing section headed
"Warchief amendment". Work on branch `task/T17-downgrade-guard`, following the branching convention in the
...
- [ ] **Step 1: Commit** — one or more conventional commits, each ending with the three
      trailers from the campaign constraints file, using `Tribe-Task: 25/40`, and
