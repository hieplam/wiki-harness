...
### Task 1: T18 — The adopt-drift mechanism, extended for a missing path

Requirement contract: `/Users/hip/repo/wiki-harness-analysis/plan/briefs/T18.md` — read it in full, including any trailing section headed
"Warchief amendment". Work on branch `task/T18-adopt-drift`, following the branching convention in the
...
- [ ] **Step 1: Commit** — one or more conventional commits, each ending with the three
      trailers from the campaign constraints file, using `Tribe-Task: 26/40`, and
