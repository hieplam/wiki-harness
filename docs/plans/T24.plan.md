...
### Task 1: T24 — CLI polish: finalize argparse and the exact message strings

Requirement contract: `/Users/hip/repo/wiki-harness-analysis/plan/briefs/T24.md` — read it in full, including any trailing section headed
"Warchief amendment". Work on branch `task/T24-cli-polish`, following the branching convention in the
...
- [ ] **Step 1: Commit** — one or more conventional commits, each ending with the three
      trailers from the campaign constraints file, using `Tribe-Task: 32/40`, and
