...
### Task 1: T25 — Write docs/compatibility-policy.md

Requirement contract: `/Users/hip/repo/wiki-harness-analysis/plan/briefs/T25.md` — read it in full, including any trailing section headed
"Warchief amendment". Work on branch `task/T25-compatibility-policy`, following the branching convention in the
...
```sh
test -f /Users/hip/repo/wiki-harness/docs/compatibility-policy.md
...
- [ ] **Step 1: Commit** — one or more conventional commits, each ending with the three
      trailers from the campaign constraints file, using `Tribe-Task: 33/40`, and
