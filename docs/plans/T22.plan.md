...
### Task 1: T22 — Idempotency fast path

Requirement contract: `/Users/hip/repo/wiki-harness-analysis/plan/briefs/T22.md` — read it in full, including any trailing section headed
"Warchief amendment". Work on branch `task/T22-idempotency`, following the branching convention in the
...
- [ ] **Step 1: Commit** — one or more conventional commits, each ending with the three
      trailers from the campaign constraints file, using `Tribe-Task: 30/40`, and
