...
### Task 1: T20 — The apply versus dry-run split

Requirement contract: `/Users/hip/repo/wiki-harness-analysis/plan/briefs/T20.md` — read it in full, including any trailing section headed
"Warchief amendment". Work on branch `task/T20-apply-dry-run-split`, following the branching convention in the
...
- [ ] **Step 1: Commit** — one or more conventional commits, each ending with the three
      trailers from the campaign constraints file, using `Tribe-Task: 28/40`, and
