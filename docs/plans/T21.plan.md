...
### Task 1: T21 — Atomic promote via try/except into git checkout

Requirement contract: `/Users/hip/repo/wiki-harness-analysis/plan/briefs/T21.md` — read it in full, including any trailing section headed
"Warchief amendment". Work on branch `task/T21-atomic-promote`, following the branching convention in the
...
- [ ] **Step 1: Commit** — one or more conventional commits, each ending with the three
      trailers from the campaign constraints file, using `Tribe-Task: 29/40`, and
