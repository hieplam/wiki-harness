...
- [x] T29 — Run the baseline oracle against the migrated clone; diff vs before/ per the 3 named deltas
- [x] T30 — PR review + merge migration to the real ogp-wiki repo (hieplam/ogp-wiki#5, merged 2026-09-03 as `01301db`)

## P5 — Second-wiki smoke

- [x] T31A — init.py: absolute hook paths in dry_run_hooks; cut v1.0.1 (INSERTED 2026-09-02 by ruling R4 — T31's smoke run found the defect)
- [x] T31 — init a throwaway synthetic ai-wiki fixture; run full E2E incl. customized id.pattern
