...
**Campaign:** wiki-harness-extraction | **Phase:** P3 — upgrade | **Depends on:** `T22`

## What this card delivers

T23 — The commit flag plus automatic rollback on a failed post-write self-check.
...
1. **T23** — T23 — The commit flag plus automatic rollback on a failed post-write self-check
   - Brief (the real contract): `/Users/hip/repo/wiki-harness-analysis/plan/briefs/T23.md`
   - Task branch: `task/T23-commit-autorollback`
   - Campaign task number: 31 of 40
