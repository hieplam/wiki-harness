...
**Campaign:** wiki-harness-extraction | **Phase:** P3 — upgrade | **Depends on:** `T21`
...
1. **T22** — T22 — Idempotency fast path
   - Brief (the real contract): `/Users/hip/repo/wiki-harness-analysis/plan/briefs/T22.md`
   - Task branch: `task/T22-idempotency`
   - Campaign task number: 30 of 40
