...
**Campaign:** wiki-harness-extraction | **Phase:** P3 — upgrade | **Depends on:** `T17`

## What this card delivers

T18 — The adopt-drift mechanism, extended for a missing path.
...
1. **T18** — T18 — The adopt-drift mechanism, extended for a missing path
   - Brief (the real contract): `/Users/hip/repo/wiki-harness-analysis/plan/briefs/T18.md`
   - Task branch: `task/T18-adopt-drift`
   - Campaign task number: 26 of 40
