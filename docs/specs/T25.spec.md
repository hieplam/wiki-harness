...
**Campaign:** wiki-harness-extraction | **Phase:** P3 — upgrade | **Depends on:** `T24`

## What this card delivers

T25 — Write docs/compatibility-policy.md.
...
1. **T25** — T25 — Write docs/compatibility-policy.md
   - Brief (the real contract): `/Users/hip/repo/wiki-harness-analysis/plan/briefs/T25.md`
   - Task branch: `task/T25-compatibility-policy`
   - Campaign task number: 33 of 40
