...
**Campaign:** wiki-harness-extraction | **Phase:** P3 — upgrade | **Depends on:** `T16B`
...
1. **T17** — T17 — Downgrade guard
   - Brief (the real contract): `/Users/hip/repo/wiki-harness-analysis/plan/briefs/T17.md`
   - Task branch: `task/T17-downgrade-guard`
   - Campaign task number: 25 of 40
