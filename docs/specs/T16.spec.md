...
**Campaign:** wiki-harness-extraction | **Phase:** P3 — upgrade | **Depends on:** `P2-close`

## What this card delivers

T16 — upgrade.py step 1: refuse-before-write drift check including missing-path drift.
...
1. **T16** — T16 — upgrade.py step 1: refuse-before-write drift check including missing-path drift
   - Brief (the real contract): `/Users/hip/repo/wiki-harness-analysis/plan/briefs/T16.md`
   - Task branch: `task/T16-drift-check`
   - Campaign task number: 23 of 40
