...
**Campaign:** wiki-harness-extraction | **Phase:** P3 — upgrade | **Depends on:** `T19`

## What this card delivers

T20 — The apply versus dry-run split.
...
1. **T20** — T20 — The apply versus dry-run split
   - Brief (the real contract): `/Users/hip/repo/wiki-harness-analysis/plan/briefs/T20.md`
   - Task branch: `task/T20-apply-dry-run-split`
   - Campaign task number: 28 of 40
