...
**Campaign:** wiki-harness-extraction | **Phase:** P3 — upgrade | **Depends on:** `T18`
...
1. **T19** — T19 — MAJOR-removal guard
   - Brief (the real contract): `/Users/hip/repo/wiki-harness-analysis/plan/briefs/T19.md`
   - Task branch: `task/T19-major-removal-guard`
   - Campaign task number: 27 of 40
